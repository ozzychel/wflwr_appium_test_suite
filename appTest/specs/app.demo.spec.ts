...
const RegScreenMenu = require('../screenobjects/android/components/RegScreenMenu');
const RegScreenBody = require('../screenobjects/android/components/RegScreenBody');
const PersonalDataForm = require('../screenobjects/android/components/PersonalDataForm');
const ListPicker = require('../screenobjects/android/components/ListPicker');
const ExtrasForm = require('../screenobjects/android/components/ExtrasForm');
const PaymentMethod = require('../screenobjects/android/components/PaymentMethod');
const RegSummary = require('../screenobjects/android/components/RegSummary');
