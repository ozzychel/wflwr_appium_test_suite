...
class Gestures {
    ...
    static async swipeOnPercentage (from: XY, to: XY) {
        ...
        // console.log(">>>>>>PressOptions", pressOptions)
        // console.log(">>>>>>MovetoScreenCoord", moveToScreenCoordinates)
    ...
    static async swipe (from: XY, to: XY) {
        // console.log("SWIPE ARGS", from, to)
        await driver.performActions([
            {
                ...
                actions: [
                    ...
                    { type: 'pointerMove', duration: 250, x: to.x, y: to.y },
